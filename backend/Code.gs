...
const HEADERS={
  POSTERS:['ID Poster','No. Giliran','Nama Sekolah','Nama Poster','Link Poster','Kategori','Status Aktif','Tarikh Kemas Kini'],
...
function setupSheets(){
  ...
  upsertSeed_(CONFIG.SHEETS.POSTERS,'ID Poster',[
    {'ID Poster':'P001','No. Giliran':1,'Nama Sekolah':'Sekolah Contoh 1','Nama Poster':'Poster Digital 1','Link Poster':'https://drive.google.com/file/d/1CPX1GEgSKbqvozIWDhctNiXC3cabaLbN/view','Kategori':'Terbuka','Status Aktif':true,'Tarikh Kemas Kini':new Date()},
    {'ID Poster':'P002','No. Giliran':2,'Nama Sekolah':'Sekolah Contoh 2','Nama Poster':'Poster Digital 2','Link Poster':'https://drive.google.com/file/d/1q9n6D7zkn2BJHn6R4JxdvuEzpbHheT0W/view','Kategori':'Terbuka','Status Aktif':true,'Tarikh Kemas Kini':new Date()},
    {'ID Poster':'P003','No. Giliran':3,'Nama Sekolah':'Sekolah Contoh 3','Nama Poster':'Poster Digital 3','Link Poster':'https://drive.google.com/file/d/1UPowuwWolILsdzELk4XAV-yMhEZF3_cD/view','Kategori':'Terbuka','Status Aktif':true,'Tarikh Kemas Kini':new Date()}
  ]);
